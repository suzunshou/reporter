 ...
 *
 * @author zunshou on 2019/11/17 4:21 下午.
 */
public class HashedWheelTimer implements Timer {
    ...
    private final Queue<HashedWheelTimeout> timeouts = new MpscUnboundedArrayQueue<HashedWheelTimeout>(MPSC_CHUNK_SIZE);
    private final Queue<HashedWheelTimeout> cancelledTimeouts = new MpscUnboundedArrayQueue<HashedWheelTimeout>(MPSC_CHUNK_SIZE);
